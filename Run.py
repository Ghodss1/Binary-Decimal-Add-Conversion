...
while True:
    ...
    print("First Number               : ", Input.num1)
    print("Second Number              : ", Input.num2)
    ...
    if len(binary_add) <= 8:
        ...
        print('Sum of numbers in Decimal   : ', dec1)
    else:
        print('This is only 8-bit adder and cannot show value more than 8-bit binary')
    choice = input("Do you want to add more? If yes enter y but if no enter n to complete the program: ")
    if choice.lower() == "y":
